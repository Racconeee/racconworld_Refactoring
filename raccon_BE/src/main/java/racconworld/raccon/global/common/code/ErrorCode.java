...
public enum ErrorCode {
    ...
    MISMATCH_ACCESS_TOKEN(401, "TOKEN_MISMATCH", "일치하지 않는 ACCESS TOKEN 입니다."),
    TOKEN_EXPIRED(401, "TOKEN_EXPIRED", "만료된 토큰입니다."),
    MISMATCH_REFRESH_TOKEN(401, "TOKEN_MISMATCH", "일치하지 않는 REFRESH TOKEN 입니다."),
    TOKEN_NOT_FOUND(403, "TOKEN_NOT_FOUND", "존재하지 않는 REFRESH TOKEN 입니다."),
    INVALID_ACCESS_TOKEN_SIGNATURE(401, "TOKEN_INVALID_SIGNATURE", "토큰의 서명이 유효하지 않습니다."),
    INVALID_TOKEN_SIGNATURE(401, "TOKEN_INVALID_SIGNATURE", "토큰의 서명이 유효하지 않습니다."),
    ...
    EXIST_SAME_TEST(409, "EXIST_SAME", "이미 같은 이름의 TEST가 존재합니다."),
