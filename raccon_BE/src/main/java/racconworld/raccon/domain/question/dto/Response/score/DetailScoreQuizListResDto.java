...
public class DetailScoreQuizListResDto {
    ...
    @Builder
    public DetailScoreQuizListResDto(String testName, TestType testType, Long view, String filePath, String fileName, List<DetailScoreQuestionListResDto> questions) {
